...
`,Oe=()=>{const{collectionTypes:t,singleTypes:a,isLoading:o}=(0,V.bP)(),{guidedTourState:l,isGuidedTourVisible:u,isSkipped:y}=(0,i.useGuidedTour)(),I=!$(l)&&u&&!y,{push:B}=(0,j.useHistory)(),x=s=>{s.preventDefault(),B("/plugins/content-type-builder/content-types/create-content-type")},p=(0,e.useMemo)(()=>{const s=We=>We.filter(Ve=>Ve.isDisplayed);return s(t).length>1||s(a).length>0},[t,a]);return o?e.createElement(i.LoadingIndicatorPage,null):e.createElement(O.Layout,null,e.createElement(f.FormattedMessage,{id:"HomePage.helmet.title",defaultMessage:"Homepage"},s=>e.createElement(D.Helmet,{title:s[0]})),e.createElement(F.Main,null,e.createElement(je,null,e.createElement("img",{alt:"","aria-hidden":!0,src:W})),e.createElement(d.Box,{padding:10},e.createElement(g.Grid,null,e.createElement(g.GridItem,{col:8,s:12},e.createElement(xe,{onCreateCT:x,hasCreatedContentType:p}))),e.createElement(g.Grid,{gap:6},e.createElement(g.GridItem,{col:8,s:12},I?e.createElement(_,null):e.createElement(De,null)),e.createElement(g.GridItem,{col:4,s:12},e.createElement(Ce,null))))))},Fe=(0,e.memo)(Oe)}}]);
